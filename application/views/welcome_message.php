    ...
    <div class="animate-block feature-block contact-feature-block">
      <div class="feature-block-inner container">
        <div class="text-center">
          <h2 class="feature-block-heading">Contact us for a free, no obligation confidential exploration of your needs</h2>
    ...
    <div id="about" class="content-block about-block">
        ...
        <div class="animate-block about-content clear">
          <div class="what-we-do-block col-6-tablet">
            ...
            <ul>
              ...
              <li>
                Electrical Fittings & Fixture Services
              </li>
              <li>
                Plaster and Cladding Works
              </li>
              <li>
                Swimming Pools Cleaning and Installation
              </li>
              <li>
                Water Tanks Cleaning Services
              </li>
            </ul>
          </div>
      ...
      <div class="about-block-inner container">
        <div class="content-block-inner text-center">
          ...
          <div class="col-10-desktop no-float center-element">
            <p>
              "Your one-stop shop for sustainable facility maintenance and professional technical services"
            </p>
          </div>
        </div>
        <div class="animate-block about-content clear">
          <div class="what-we-do-block col-6-tablet">
            <h3 class="h3">Company Mission</h3>
            <p>To build economic, efficient and best-in-class facility maintenance and technical services with advanced technology tailored specifically to each client.</p>

            <h3 class="h3">Company Vision</h3>
            <p>To be widely known across the GCC as integrated provider of technical and efficient facility management services.</p>
            <br />
            <h6 class="item-heading" style="color: #000;">Here at E.R.T.S, RELIABILITY of your FACILITY NEED is our PASSION.</h6>
          </div>
          <div class="our-clients-block col-6-tablet clear">
            <h3 class="h3">Core Values</h3>
              <ul>
                <li>Be a trusted authority and innovative leader in the field of technical services.</li>
                <li>Be a respected and reputable establishment in providing facility maintenance.</li>
                <li>Maintain the high caliber workmanship in providing quality services compliant to national and international standards.</li>
                <li>Help homes, businesses and institutions achieve the best value for their investments.</li>
                <li>Expand reaches and break horizons in fields related to facility management services.</li>
              </ul>
          </div>
        </div>
      </div>
            ...
            <div class="news-item news-item-third clear">
              ...
              <div class="news-item-content">
                <div class="news-item-content-inner">
                  <h3 class="news-item-title"><a href="#">Making the most of generation assets in turbulent times</a></h3>
                  <p>
        ...
        <div class="clear">
          <div class="contact-block-content col-6-tablet">
            ...
            <ul class="contact-list">
              ...
              <li><span class="icon contact-icon contact-icon-email"><a style="text-transform: none;" href="mailto:info.eladioramonidatechservice@gmail.com">info.eladioramonidatechservice@gmail.com</a></span></li>
            </ul>
